...
export function ClienteFAB({ onClick, className }) {
  return (
    <button
      ...
      title="Nuevo cliente"
      className={clsx(
        'fixed right-4 z-30 flex h-14 w-14 items-center justify-center rounded-full shadow-glow',
        'bottom-[calc(5.5rem+env(safe-area-inset-bottom))] sm:bottom-8 lg:right-8 lg:bottom-10',
