        ...
        <button
          ...
          className={clsx(
            ...
            value === o.id
              ...
              : 'border-white/50 bg-white/60 backdrop-blur-md text-navy-700 hover:bg-white/80 dark:border-white/10 dark:bg-white/[0.06] dark:text-navy-100 dark:hover:bg-white/10',
          )}
        >
          {o.label}
          <span
            className={clsx(
              ...
              value === o.id
                ...
                : 'bg-slate-200 text-slate-700 dark:bg-white/10 dark:text-navy-200',
            )}
          >
            {o.count}
          </span>
