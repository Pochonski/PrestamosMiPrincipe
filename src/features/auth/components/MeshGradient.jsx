  ...
  return (
    ...
    >
      <div
        className={
          isApp
            ? 'absolute -top-32 -left-24 h-96 w-96 rounded-full bg-gold-400/50 opacity-50 blur-3xl animate-mesh-1 dark:bg-gold-500/55 dark:opacity-40'
      ...
      <div
        className={
          isApp
            ? 'absolute -bottom-32 -right-24 h-[28rem] w-[28rem] rounded-full bg-sky-400/35 opacity-35 blur-3xl animate-mesh-2 dark:bg-info-500/40 dark:opacity-35'
      ...
      <div
        className={
          isApp
            ? 'absolute top-1/3 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-emerald-400/30 opacity-30 blur-3xl animate-mesh-3 dark:bg-glow-violet/35 dark:opacity-30'
