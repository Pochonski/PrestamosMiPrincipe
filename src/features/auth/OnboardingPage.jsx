...
export function OnboardingPage() {
  ...
  return (
    <div className="grid min-h-screen grid-cols-1 bg-slate-50 dark:bg-navy-950 lg:grid-cols-2">
      <div className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-navy-900 via-navy-800 to-navy-950 p-12 text-white lg:flex">
        <MeshGradient />
        ...
        <div className="relative z-10 space-y-6">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-gold-gradient/20 text-gold-300">
          ...
          <p className="max-w-md text-base text-navy-200">
            Estás a un paso de empezar. Solo necesitamos un nombre para tu organización
            y todo queda listo.
          </p>
        </div>
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="mb-6 flex items-center gap-3 lg:hidden">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-navy-300">{user?.email}</p>
            </div>
          </div>
