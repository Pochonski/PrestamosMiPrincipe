...
export const NAV_ITEMS = [
  ...
  { id: 'cobrar-hoy', label: 'Cobros', icon: HandCoins, path: '/cobrar-hoy', mobile: true, section: 'principal' },
  ...
  { id: 'clientes', label: 'Clientes', icon: Users, path: '/clientes', mobile: false, section: 'principal' },
