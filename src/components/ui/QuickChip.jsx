...
const tones = {
  neutral: 'bg-white/60 backdrop-blur-md border-white/50 text-navy-700 hover:bg-white/80 dark:bg-white/[0.06] dark:border-white/10 dark:text-navy-100 dark:hover:bg-white/10',
